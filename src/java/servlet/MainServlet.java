...
public class MainServlet extends HttpServlet {
    ...
    private void showDashboard(HttpServletRequest request, HttpServletResponse response,
        ...
        if ("admin".equals(currentUser.getRole())) {
            ...
            request.setAttribute("listUser", users);  // Note: Changed to match JSP
            request.setAttribute("listTask", tasks);  // Note: Changed to match JSP

            // Use absolute path from context root
    ...
    private void forwardToPublicJsp(String page, HttpServletRequest request,
            HttpServletResponse response) throws ServletException, IOException {
        request.getRequestDispatcher("/WEB-INF/views/auth/" + page + ".jsp")
                .forward(request, response);
    }

    private void forwardToJsp(String path, HttpServletRequest request,
            HttpServletResponse response) throws ServletException, IOException {
    ...
    private void showUserForm(HttpServletRequest request, HttpServletResponse response,
        ...
        forwardToJsp("user/form", request, response);
    }
    ...
    private void listUsers(HttpServletRequest request, HttpServletResponse response)
        ...
        forwardToJsp("user/list", request, response);
    }
    ...
    private void showTaskForm(HttpServletRequest request, HttpServletResponse response,
        ...
        request.setAttribute("action", action);
        forwardToJsp("task/form", request, response);
    }
    ...
    private void listTasks(HttpServletRequest request, HttpServletResponse response,
            User currentUser) throws SQLException, IOException, ServletException {
        List<Task> tasks = "admin".equals(currentUser.getRole())
                ? taskDao.selectAllTasks() : taskDao.selectUserTasks(currentUser.getId());
        request.setAttribute("tasks", tasks);
        forwardToJsp("task/list", request, response);
    }
    ...
    private void showAdminDashboard(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("users", users);
        request.setAttribute("tasks", tasks);
        forwardToJsp("admin/dashboard", request, response);
    }
}
